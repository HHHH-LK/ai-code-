...
public class CodeFileSaverExecutor {
    ...
    private static final MutiFileCodeSaverTemplate multiFileCodeFileSaver = new MutiFileCodeSaverTemplate();

    private static final VueProjectFileSaverTemplate vueProjectFileSaver = new VueProjectFileSaverTemplate();
